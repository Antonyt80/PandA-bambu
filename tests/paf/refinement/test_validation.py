...
class Validation(unittest.TestCase):
 ...
 def test_declared_source_linked_semantic_drift_can_pass(self):
  ...
  change={'change_id':'resolved-u','classification':'unknown-removed','semantic_key':'$semantic-state','before':before,'after':after,'source_refs':['s'],'rationale':'evidence','admission_required':True}
