...
|---|---|---|---|---|---|---|---|---|---|---|---|
| PAF-REQ-IDENTITY-001 | Separate logical ID, immutable revision, canonical bytes and typed digest. | [paf-contract-requirements-matrix.md — Canonicalization and digest expectations](paf-contract-requirements-matrix.md#canonicalization-and-digest-expectations); PAF-UC-PROV-001 | 2a Contract Envelope | registry | all contracts | 2a | [PF-IDENTITY-001 and DEC-001–005 vectors](../../tests/paf/identity/vectors/paf_identity_v1.json) | [NF-IDENTITY-001 through NF-IDENTITY-006](../../tests/paf/identity/vectors/paf_identity_v1.json) | identity-layer-separation (`tests/paf/identity/test_identity.py`) | [focused API suite and offline Python/Node readers](../../tests/paf/identity/test_identity.py) | implemented-and-tested |
